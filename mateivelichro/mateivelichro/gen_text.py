def gen_text(in_val):
    return {
        'about': (
            '<p style="font-size:20px; position: relative;margin-right: 2em;margin-left: 2em; margin-top: 5em; margin-bottom: 0em; text-align: left;"><b>About Me</b><br><br>'
                ...
                "In the past, I have worked on various small personal projects (mostly in C# but I have explored the entire .net ecosystem) which later evolved into automating server-side ETL processes in various scripting languages (Python, VB, powershell).<br><br>"
                "Now allot of my work revolves around developing server-side ETL processes.</p>"
                ),
        'edu': (

                '<p style="font-size:20px; position: relative;margin-right: 2em;margin-left: 2em; margin-top: 5em; margin-bottom: 0em; text-align: left;"><b>Education</b><br><br><br>'
        ...
        'xp':(
            '<p style="font-size:20px; position: relative;margin-right: 2em;margin-left: 2em; margin-top: 5em; margin-bottom: 0em; text-align: left;"><b>Experience</b><br>'
        ...
        'contact':(
            '<p style="font-size:20px; position: relative;margin-right: 2em;margin-left: 2em; margin-top: 5em; margin-bottom: 0em; text-align: left;"><b>Contact</b><br><br><br>'
