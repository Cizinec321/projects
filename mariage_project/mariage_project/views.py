...
def home(request):
        ...
        if langval=='EN':
                ...
                seatingform_wrapper_start_show_wbutton='<div class="dropbtn2_alt_show" id="seating"><form method="post" style="width:100%;height:100%;display:inline-block;"><button type="submit" class="pos_button_unload" value="1">Close</button></form>'
                ...
                seatingform_wrapper_start_hide='<div class="dropbtn2" id="seating"><form method="post"  name="seating_request" style="width:100%;height:100%;display:inline-block;"><table style="width:100%">'
                seatingform_wrapper_start_hide_alt='<div class="dropbtn2_alt" id="seating"><form method="post"  name="seating_request" style="width:100%;height:100%;display:inline-block;"><table style="width:100%">'
                seatingform_wrapper_start_show_wbutton='<div class="dropbtn2_alt_show" id="seating"><form method="post" style="width:100%;height:100%;display:inline-block;"><button type="submit" class="pos_button_unload" value="1">Închide</button></form>'
