...
def home(request):
    ...
    if 'Mobile' in agent:
        ...
        if uval!=None and pval!=None:
                ...
                if user==None:
                       return render(request,'landing.html',{'click_check_div3':gen_dat.gen_text(),'seat_handling_form':form_list_non_su,'click_form_login':login_form,'invitees_handling_form':gen_dat.details_load(),'form_wrapper_start':'<div class="dropbtn2" id="login"><form method="post"  name="login_request"><table style="width:100%">','form_wrapper_end':'<tr><th></th><th><button type="submit" class="pos_button2" name="login_request" value="1" >Transmite</button></th><td></td></tr></table></form></div>'})
                else:
                        login(request,user)
        ...
        if request.POST.get("seating_request"):
              ...
              if template!='':
                ...
                if request.user.is_superuser:
                        return render(request,'landing_log.html',{'click_check_div3':gen_dat.gen_text(),'seat_handling_form':form_list,'invitees_handling_form':gen_dat.details_load(),'form_wrapper_start':'<div class="dropbtn2" id="login"><form method="post"  name="login_request"><table style="width:100%">','form_wrapper_end':'<tr><th></th><th><button type="submit" class="pos_button2" name="add_participant" value="1">Schimbă</button></th><td></td></tr></table></form></div>','form_wrapper_end_non_su':'<tr><th></th><th><button type="submit" class="pos_button2" name="add_participant" value="1">Schimbă</button></th><td></td></tr></table></form></div>','click_form_register':register_form,'click_ee_list':gen_dat.get_party_full(),'click_form_seating':seating_table,'registerform_wrapper_start':'<div class="dropbtn2" id="register"><form method="post"  name="login_request"><table style="width:100%">','registerform_wrapper_end':'</div>','seatingform_wrapper_start':'<div class="dropbtn2_alt_show" id="seating"><form method="post"><button type="submit" class="pos_button_unload" value="1">Închide</button></form>','seatingform_wrapper_end':'</div>'})
                else:
                        return render(request,'landing_log.html',{'click_check_div3':gen_dat.gen_text(),'seat_handling_form':form_list_non_su,'invitees_handling_form':gen_dat.details_load_non_su(request.user),'form_wrapper_start':'<div class="dropbtn2" id="login"><form method="post"  name="login_request"><table style="width:100%">','form_wrapper_end':'<tr><th></th><th><button type="submit" class="pos_button2" name="add_participant" value="1">Schimbă</button></th><td></td></tr></table></form></div>','form_wrapper_end_non_su':'<tr><th></th><th><button type="submit" class="pos_button2" name="add_participant" value="1">Schimbă</button></th><td></td></tr></table></form></div>','click_ee_list':gen_dat.get_party_full_non_su(request.user),'click_form_seating':seating_table_non_su,'registerform_wrapper_start':'<div class="dropbtn2" id="register"><form method="post"  name="login_request"><table style="width:100%">','registerform_wrapper_end':'</div>','seatingform_wrapper_start':'<div class="dropbtn2_alt_show" id="seating"><form method="post"><button type="submit" class="pos_button_unload" value="1">Închide</button></form>','seatingform_wrapper_end':'</div>'})
        ...
        if request.POST.get('save_participant'):
                ...
                if request.user.is_superuser:
                        ...
                        return render(request,'landing_log.html',{'click_check_div3':gen_dat.gen_text(),'seat_handling_form':form_list_non_su,'click_form_login':login_form,'invitees_handling_form':gen_dat.details_load_non_su(request.user),'form_wrapper_start':'<div class="dropbtn2" id="login"><form method="post"  name="login_request"><table style="width:100%">','form_wrapper_end':'<tr><th></th><th><button type="submit" class="pos_button2" name="login_request" value="1">Transmite</button></th><td></td></tr></table></form></div>','form_wrapper_end_non_su':'<tr><th></th><th></th><td></td></tr></table></form></div>','click_ee_list':gen_dat.get_party_full_non_su(request.user),'click_form_seating':seating_table_non_su,'registerform_wrapper_start':'<div class="dropbtn2_show" id="register"><form method="post"  name="login_request"><table style="width:100%">','registerform_wrapper_end':'</div>','seatingform_wrapper_start':'<div class="dropbtn2_alt_show" id="seating"><form method="post"  name="seating_request"><table style="width:100%">','seatingform_wrapper_end':'<tr><th></th><th><button type="submit" class="pos_button2" name="seating_request" value="1" >Transmite</button><button type="submit" class="pos_button2" name="publsh_request" value="1" >Publică</button></th><td></td></tr></table></form></div>'})
        ...
        if request.POST.get("inv_save"):
                ...
                if request.user.is_superuser:
                        ...
                        return render(request,'landing_log.html',{'click_check_div3':gen_dat.gen_text(),'seat_handling_form':form_list_non_su,'click_form_login':login_form,'invitees_handling_form':gen_dat.details_load_non_su(request.user),'form_wrapper_start':'<div class="dropbtn2" id="login"><form method="post"  name="login_request"><table style="width:100%">','form_wrapper_end':'<tr><th></th><th><button type="submit" class="pos_button2" name="login_request" value="1">Transmite</button></th><td></td></tr></table></form></div>','form_wrapper_end_non_su':'<tr><th></th><th></th><td></td></tr></table></form></div>','click_ee_list':gen_dat.get_party_full_non_su(request.user),'click_form_seating':seating_table_non_su,'registerform_wrapper_start':'<div class="dropbtn2_show" id="register"><form method="post"  name="login_request"><table style="width:100%">','registerform_wrapper_end':'</div>','seatingform_wrapper_start':'<div class="dropbtn2_alt" id="seating"><form method="post"  name="seating_request"><table style="width:100%">','seatingform_wrapper_end':'<tr><th></th><th></th><td></td></tr></table></form></div>'})
