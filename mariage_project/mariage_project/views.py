...
def home(request):
        ...
        if uval!=None and pval!=None:
                ...
                if user==None:
                       return render(request,'landing.html',{'language':langval,'language':langval,'click_check_div3':gen_dat.gen_text(langval,'main_hidetxt'),'click_form_login':login_form,'invitees_handling_form':gen_dat.details_load(),'form_wrapper_start':form_wrapper_start_def,'form_wrapper_end':form_wrapper_end_not_log})
                else:
                        login(request,user)
        ...
        if request.POST.get("seating_request"):
              ...
              if template!='':
                ...
                if request.user.is_superuser:
                        return render(request,'landing_log.html',{'language':langval,'click_check_div3':gen_dat.gen_text(langval,'main_hidetxt'),'seat_handling_form':form_list,'invitees_handling_form':gen_dat.details_load(),'form_wrapper_start':form_wrapper_start_def,'form_wrapper_end':form_wrapper_end_seat_aloc,'form_wrapper_end_non_su':form_wrapper_end_non_su_wbutton,'click_form_register':register_form,'click_ee_list':gen_dat.get_party_full(),'click_form_seating':seating_table,'registerform_wrapper_start':registerform_wrapper_start_hidden,'seatingform_wrapper_start':seatingform_wrapper_start_show_wbutton,'seatingform_wrapper_end':'</div>'})
                else:
                        return render(request,'landing_log.html',{'language':langval,'click_check_div3':gen_dat.gen_text(langval,'main_hidetxt'),'seat_handling_form':form_list_non_su,'invitees_handling_form':gen_dat.details_load_non_su(request.user,langval),'form_wrapper_start':form_wrapper_start_def,'form_wrapper_end':form_wrapper_end_seat_aloc,'form_wrapper_end_non_su':form_wrapper_end_non_su_wbutton,'click_form_seating':seating_table_non_su,'registerform_wrapper_start':registerform_wrapper_start_hidden,'seatingform_wrapper_start':seatingform_wrapper_start_show_wbutton,'seatingform_wrapper_end':'</div>'})
        ...
        if request.POST.get('save_participant'):
                ...
                if request.user.is_superuser:
                        ...
                        return render(request,'landing_log.html',{'language':langval,'click_check_div3':gen_dat.gen_text(langval,'main_hidetxt'),'seat_handling_form':form_list_non_su,'click_form_login':login_form,'invitees_handling_form':gen_dat.details_load_non_su(request.user,langval),'form_wrapper_start':form_wrapper_start_def,'form_wrapper_end':form_wrapper_end_seat_gen,'form_wrapper_end_non_su':form_wrapper_end_non_su_nobutton,'click_form_seating':seating_table_non_su,'registerform_wrapper_start':registerform_wrapper_start_show,'seatingform_wrapper_start':seatingform_wrapper_start_show,'seatingform_wrapper_end':seatingform_wrapper_end_wbutton})
        ...
        if request.POST.get("inv_save"):
                ...
                if request.user.is_superuser:
                        ...
                        return render(request,'landing_log.html',{'language':langval,'click_check_div3':gen_dat.gen_text(langval,'main_hidetxt'),'seat_handling_form':form_list_non_su,'click_form_login':login_form,'invitees_handling_form':gen_dat.details_load_non_su(request.user,langval),'form_wrapper_start':form_wrapper_start_def,'form_wrapper_end':form_wrapper_end_seat_gen,'form_wrapper_end_non_su':form_wrapper_end_non_su_nobutton,'click_form_seating':seating_table_non_su,'registerform_wrapper_start':registerform_wrapper_start_show,'seatingform_wrapper_start':seatingform_wrapper_start_hide_alt,'seatingform_wrapper_end':seatingform_wrapper_end_nobutton})
